    ...
    <section className="relative overflow-hidden pt-16 pb-20 md:pt-28 md:pb-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-950/20 px-4 py-2 text-xs text-cyan-300 backdrop-blur-xl mb-10 shadow-[0_0_15px_rgba(6,182,212,0.1)] laser-line"
        >
        ...
        <motion.h1
          ...
          className="text-5xl font-black tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl font-sans leading-[1.1] md:leading-[1.05]"
        >
        ...
        >
          <button
            ...
            className="w-full sm:w-auto overflow-hidden rounded-xl bg-gradient-to-r from-[#7C3AED] to-[#06B6D4] p-[1.5px] font-sans text-sm font-bold tracking-wide text-white transition-all duration-300 hover:scale-[1.04] hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] active:scale-95 cursor-pointer flex justify-center items-center"
          >
            <span className="w-full h-full flex items-center justify-center gap-2 bg-[#0B1020]/90 px-8 py-4 rounded-[11px] hover:bg-transparent transition-colors duration-300">
              <Layers className="h-4 w-4 text-purple-300 animate-pulse" />
              Launch Merge Stream
            </span>
          </button>
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.03] hover:bg-white/[0.08] hover:border-white/20 active:scale-95 px-8 py-4.5 text-sm font-bold text-white transition-all duration-300 cursor-pointer backdrop-blur-md"
          >
        ...
        <motion.div
          ...
          className="mx-auto mt-20 max-w-5xl rounded-3xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative"
        >
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:gap-8">
            <div className="flex flex-col items-center justify-center p-4 rounded-2xl bg-white/[0.01] border border-white/[0.02] hover:border-white/[0.05] transition-colors">
          ...
          <div className="mt-8 flex items-center justify-center gap-3 border-t border-white/5 pt-6 text-xs text-[#94A3B8] leading-relaxed">
            <ShieldAlert className="h-5 w-5 text-cyan-500 shrink-0 animated-pulse" />
      ...
      <div className="absolute top-[40%] left-[5%] w-48 h-48 bg-purple-600/5 rounded-full blur-[90px] animate-pulse pointer-events-none" />
      <div className="absolute top-[15%] right-[8%] w-56 h-56 bg-cyan-600/5 rounded-full blur-[100px] animate-pulse pointer-events-none" />
    </section>
  );
}
